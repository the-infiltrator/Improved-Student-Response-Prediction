...
def main():
    ...
    k_star, best_epoch = tune_latent_dim(data, k_values, metrics,
    ...
    l_star, best_epoch = tune_shrinkage(data, lamb_values, metrics,
                                        hyperparameters, weights)
    ...
    model = train(
        ...
        data["train_matrix"], data["zero_train_matrix"],
        data["valid_data"], hyperparameters["num_epoch"], metrics, k_star,
        False, data["valid_matrix"], data["zero_valid_matrix"], weights)
